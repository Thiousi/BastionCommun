...
<form action="<?php echo page('smart-submit')->url().'?handler=edit' ?>" data-response-div="annonce" method="post" class="smart-submit">
	...
	<div class="viewOnly">
		<button class="btn btn-primary btn-lg button editButton" data-toggle="button"><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>  Modifier</button> 
	</div>
	...
	<div class="btn-group" role="group">
		...
		<div class="btn-group editOnly" role="group">
			<button type="submit" name="submit" class="btn btn-lg btn-primary cancelButton"><span class='glyphicon glyphicon-remove' aria-hidden='true'></span> Annuler</button> 
		</div>
		<div class="btn-group editOnly" role="group">
